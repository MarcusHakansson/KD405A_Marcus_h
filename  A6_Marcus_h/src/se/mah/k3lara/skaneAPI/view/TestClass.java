...
public class TestClass {
	...
	public static void main(String[] args) {
		//Fetches information from two station ID values from which you would like to travel, and how many departures you would like to see.
	   ...
	   //Creates an arraylist to put the information in.
